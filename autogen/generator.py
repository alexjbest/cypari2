...
cdef class Gen_base:
    """
    Wrapper for a PARI ``GEN`` containing auto-generated functions.
    ...
    You almost certainly want to use the derived class :class:`Gen`
    instead. That being said, :class:`Gen_base` can be used by itself to
    pass around a temporary ``GEN`` within Python where we cannot use C
    calls.
    """
'''
